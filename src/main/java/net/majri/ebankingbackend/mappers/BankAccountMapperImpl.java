package net.majri.ebankingbackend.mappers;

import net.majri.ebankingbackend.dtos.AccountOperationDTO;
import net.majri.ebankingbackend.dtos.CurrentBankAccountDTO;
import net.majri.ebankingbackend.dtos.CustomerDTO;
import net.majri.ebankingbackend.dtos.SavingBankAccountDTO;
